...
public:
    MapController() {
        ...
        cur_map_model->SetModelSize(GlobalVars::x_size,GlobalVars::y_size);
    }
    ~MapController() {
        if(cur_map_model)delete cur_map_model;
    }
        ...
        while (GlobalVars::isGameOver == false) {
            ...
            case -32: {
                ...
                case 80:
                    ...
                    break;
                case 77:
                    smth_snake2->SetNewOrentation(SnakeModel::orentation::right);
                    break;
                }
                break;
            }
    ...
    void AddSnake() {
        ...
        smth_snake->SetStartPos(GlobalVars::x_size-1, GlobalVars::y_size - 1);
...
private:
    void time_move() {
        while (GlobalVars::isGameOver == false) {
            ...
            std::this_thread::sleep_for(std::chrono::milliseconds(GlobalVars::speed_time));
        }
        
    }
private:
    void draw_snake(SnakeController *smth_cnake, std::list<std::string> &res_map) {
